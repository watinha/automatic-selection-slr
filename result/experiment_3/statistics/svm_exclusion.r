...
shapiro.test(excluded[,'svm.k50'])
shapiro.test(excluded[,'svm.k100'])
shapiro.test(excluded[,'svm.k300'])
shapiro.test(excluded[,'svm.k1000'])
shapiro.test(excluded[,'svm.k3000'])
shapiro.test(excluded_baseline[,'svm.k50'])
shapiro.test(excluded_baseline[,'svm.k100'])
shapiro.test(excluded_baseline[,'svm.k300'])
shapiro.test(excluded_baseline[,'svm.k1000'])
shapiro.test(excluded_baseline[,'svm.k3000'])

ex_df <- excluded[, svm_classifiers]
...
ex_df <- excluded_baseline[, svm_classifiers]
